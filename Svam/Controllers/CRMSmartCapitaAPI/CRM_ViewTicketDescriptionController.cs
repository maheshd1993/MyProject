...
{
    public class CRM_ViewTicketDescriptionController : ApiController
    {
        #region Define Entity Class
        niscrmEntities db = new niscrmEntities();
        #endregion
        //api/CRM_ViewTicketDescription?TicketId=383&CompanyID=307&BranchID=184&Token=VwFdB3OPEwOoHnr15a5qgg==
        /// <summary>
        ...
        public HttpResponseMessage Get(int TicketId, string CompanyID, string BranchID, string Token)
        {
            ...
            try
            {
                ...
                DataTable Gettickectdetaillist = DataAccessLayer.GetDataTable("call CRM_TicketMap(" + TicketId + ")");
