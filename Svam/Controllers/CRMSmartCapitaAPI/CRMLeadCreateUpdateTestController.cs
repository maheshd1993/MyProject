...
{
    public class CRMLeadCreateUpdateTestController : ApiController
    {
        ...
        public HttpResponseMessage Post([FromBody]JToken postData/*, HttpRequestMessage request*/)
        {
            ...
            APILeadModel value = JsonConvert.DeserializeObject<APILeadModel>(postData.ToString());
            ...
            using (var trans = db.Database.BeginTransaction())
            {
                try
                {
                    ...
                    if (LeadID > 0)
                    {
                        ...
                        #region Update-Leads
                        var GetLeads = db.crm_createleadstbl.Where(em => em.Id == LeadID && em.BranchID == branchID && em.CompanyID == companyID).FirstOrDefault();
                        ...
                        if (GetLeads != null)
                        {
                            ...
                            if (!string.IsNullOrWhiteSpace(value.Description))
                            {
                                ...
                                if (!String.IsNullOrEmpty(GetLeads.FollowDate.Value.ToShortDateString()))
                                {
                                    ...
                                    //DateTime PreFolloupDate = Convert.ToDateTime(GetLeads.FollowDate);
                                    //if (localTime.Date > PreFolloupDate.Date)
                                    //{
                                    //    crm_delayedfollowuprecordtbl dfr = new crm_delayedfollowuprecordtbl();
                                    //    dfr.CreatedBy = UID;
                                    //    dfr.CreatedDate = localTime.Date;
                                ...
                                #region Manage-LeadHistory
                                //crm_leadsupdatetblhistory ULtH = new crm_leadsupdatetblhistory();
                                //ULtH.LeadOwner = GetLeads.LeadOwner;
                                //ULtH.LeadStatusID = value.LeadStatusID;
                                //ULtH.LeadStatus = value.LeadStatusName;
                                //ULtH.LeadSourceID = value.LeadSourceID;
                                //ULtH.LeadResource = value.LeadSourceName;
                                //ULtH.ProductTypeId = value.ProductTypeID;
                                //ULtH.Customer = value.Customer;
                                //ULtH.Designation = value.Designation;
                                //ULtH.MobileNo = value.MobileNo.Trim();
                                //ULtH.EmailId = value.EmailId;
                                //ULtH.OrganizationName = value.OrganizationName;
                                //ULtH.CountryID = value.CountryID;
                                //ULtH.Country = value.Country;
                                //ULtH.CityID = value.CityID;
                                //ULtH.City = value.City;
                                //ULtH.StateID = value.StateID;
                                //ULtH.State = value.State;
                                //ULtH.ZoneName = value.TimeZoneName;
                                //if (!string.IsNullOrWhiteSpace(value.FollowDate))
                                //{
                                //    ULtH.FollowDate = DateTime.ParseExact(value.FollowDate, "dd/MM/yyyy", CultureInfo.InvariantCulture);
                                //    ULtH.FollowUpTime = value.FollowupTime;
                                //    ULtH.FollowupTimeinIST = value.FollowupTimeIST;
                                //}
                                //ULtH.Url = value.URL;
                                //ULtH.SkypeId = value.SkypeId;
                                //ULtH.Description = value.Description;
                                //ULtH.Status = true;
                                //ULtH.date = System.DateTime.Now.ToString("dd/MM/yyyy");
                                //ULtH.Createddate = System.DateTime.Now;
                                //ULtH.LeadsType = "Manual";
                                //ULtH.HistoryDate = System.DateTime.Now;
                                //ULtH.UpdatedBy = UID;
                                //ULtH.Address = value.Address;
                                //ULtH.BranchID = branchID;
                                //ULtH.CompanyID = companyID;
                                //db.crm_leadsupdatetblhistory.Add(ULtH);
                                #endregion
                                ...
                                //                FileName = "Lead-" + value.UserName + "-" + GetLeads.Customer + "-" + DateTime.Now.ToString("ddMMyyyyhhmmss") + "";
                                ...
                                LD.Description = value.Description;
                                LD.ByUID = UID;
                    ...
                    else
                    {
                        ...
                        creatleadsTbl.EmailId = value.EmailId;
        ...
        private string GetCustomerID(String companyID)
        {
            ...
            try
            {
                ...
                Int32 getCustomerID = db.customers.Where(em => em.CompanyID == companyID).Count();
                if (getCustomerID > 0)
                {
                    if (getCustomerID == 0)
                    {
                    ...
                    {
                        if (CompanyProfile == null && ID == 1)
                        {
                            getID = "SCD-CUSL-" + getCustomerID++;
                        }
                        else
                        {
                            getID = CompanyProfile.Organization.Substring(0, 3).ToUpper() + "-CUSL-" + getCustomerID++;
                        }
                    }
                }
                return getID;
        ...
        //    // Initialization  
        //    HttpResponseMessage response = null;
        //    APILeadModel requestObj = JsonConvert.DeserializeObject<APILeadModel>(postData.ToString());
        //    DataTable responseObj = new DataTable();
        //    string json = string.Empty;
        //    json = JsonConvert.SerializeObject(responseObj);
        //    response = Request.CreateResponse(HttpStatusCode.OK);
        ...
        //                    {
        //                        DateTime PreFolloupDate = Convert.ToDateTime(GetLeads.FollowDate);
        //                        if (System.DateTime.Now.Date > PreFolloupDate.Date)
        //                        {
        //                            crm_delayedfollowuprecordtbl dfr = new crm_delayedfollowuprecordtbl();
        //                            dfr.CreatedBy = UID;
        //                            dfr.CreatedDate = localTime.Date;
        ...
        //                    GetLeads.Customer = value.Customer;
        //                    GetLeads.Designation = value.Designation;
        //                    GetLeads.MobileNo = value.MobileNo;
        //                    GetLeads.EmailId = value.EmailId;
        //                    GetLeads.OrganizationName = value.OrganizationName;
        //                    GetLeads.Description = value.Description;
        //                    GetLeads.ZoneName = value.TimeZoneName;
        ...
        //                    GetLeads.StateID = value.StateID;
        //                    GetLeads.State = value.State;
        //                    GetLeads.ModifiedDate = System.DateTime.Now;
        //                    GetLeads.Address = value.Address;
        //                    GetLeads.BranchID = branchID;
        //                    GetLeads.CompanyID = companyID;
        //                    #endregion
        ...
        //                            {
        //                                var CLM = db.crm_createleadstbl.Where(em => em.Id == LeadID && em.BranchID == branchID && em.CompanyID == companyID).FirstOrDefault();
        //                                FileName = "Lead-" + value.UserName + "-" + CLM.Customer + "-" + DateTime.Now.ToString("ddMMyyyyhhmmss") + "";
        //                                FileFullName = FileName + extension;
        //                                var filePath = HttpContext.Current.Server.MapPath("~/LeadAttachment/" + FileName + extension);
        //                                postedFile.SaveAs(filePath);
        //                            }
        ...
        //            creatleadsTbl.LeadStatus = value.LeadStatusName;
        //            creatleadsTbl.LeadSourceID = value.LeadSourceID;
        //            creatleadsTbl.LeadResource = value.LeadSourceName;
        //            creatleadsTbl.ProductTypeID = value.ProductTypeID;
        //            creatleadsTbl.ProductTypeName = value.ProductTypeName;
        //            creatleadsTbl.Customer = value.Customer;
        //            creatleadsTbl.Designation = value.Designation;
        //            creatleadsTbl.MobileNo = value.MobileNo;
        //            creatleadsTbl.EmailId = value.EmailId;
        //            creatleadsTbl.OrganizationName = value.OrganizationName;
        //            creatleadsTbl.CountryID = value.CountryID;
        //            creatleadsTbl.Country = value.Country;
        ...
        //            creatleadsTbl.Address = value.Address;
        //            creatleadsTbl.Createddate = localTime;
        //            creatleadsTbl.date = System.DateTime.Now.ToString("dd/MM/yyyy");
        //            creatleadsTbl.BranchID = branchID;
        //            creatleadsTbl.CompanyID = companyID;
        //            db.crm_createleadstbl.Add(creatleadsTbl);
        //            if (db.SaveChanges() > 0)
        ...
        //                        {
        //                            //var CLM = db.crm_createleadstbl.Where(em => em.Id == LeadID && em.BranchID == branchID && em.CompanyID == companyID).FirstOrDefault();
        //                            FileName = "Lead-" + value.UserName + "-" + value.Customer + "-" + DateTime.Now.ToString("ddMMyyyyhhmmss") + "";
        //                            FileFullName = FileName + extension;
        //                            var filePath = HttpContext.Current.Server.MapPath("~/LeadAttachment/" + FileName + extension);
        //                            postedFile.SaveAs(filePath);
        //                        }
        ...
        //        if (value.LeadStatusName == "Closed")
        //        {
        //            int LastSyncID = 0;
        //            DataTable dtLastSync = DataAccessLayer.GetDataTable("call CRM_CustomerLastSyncID('" + value.CompanyID + "'," + value.BranchID + ")");
        //            if (dtLastSync.Rows.Count > 0)
        //            {
        //                LastSyncID = Convert.ToInt32(dtLastSync.Rows[0]["syncid"]);
        //            }
        //            else
        //            {
        //                LastSyncID = 1;
